...
# BOT 1: MARKETING
TOKEN_BOT1 = os.getenv("TOKEN_BOT1", "8697427192:AAFKlxy7nNhONkpvjhNZksyq_J4AESkcEjY")

# BOT 2: PRINTER
TOKEN_BOT2 = os.getenv("TOKEN_BOT2", "8473947230:AAEH8ioKKIL3EP8uwHF8hjxDaivCGytkmJA")

# Teu Chat ID
CHAT_ID = os.getenv("CHAT_ID", "93372553")
...
╚════════════════════════════════════════════════════════════════════════════╝
    ...
    print("\n[📍] Deixa este Railway a correr 24/7!")
